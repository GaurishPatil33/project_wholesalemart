...
const Images = [
  { id: 1, src: "/banners/1.webp" },
  { id: 2, src: "/banners/2.webp" },
  { id: 3, src: "/banners/3.jpg" },
  { id: 4, src: "/banners/4.webp" },
  { id: 5, src: "/banners/5.png" },
  { id: 6, src: "/banners/6.png" },
]
...
const ImageBanner = () => {
  ...
  return (
    <section
      className="relative w-full mt-2 md:mt-2 min-h-125  max-h-150 "
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-20">
        {
          ...
          Images.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full transition-all ${i === current ? "bg-gray-900 w-5" : "bg-white/70 w-2"
                }`}
            />
          ))}
      </div>
