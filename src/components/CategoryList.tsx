      ...
      <div className="relative bg-gradient-to-b from-[#900002]/5 to-[#900001]/20 py-3 md:py-6 mx-auto px-2 md:px-6">
        ...
        <div className="relative hidden md:block">
          ...
          {showLeft && (
            <button
              onClick={() => scroll("left")}
              className="hidden md:flex absolute top-1/2 left-2 -translate-y-1/2 bg-white/40 shadow-md rounded-full p-2 hover:bg-gray-100"
            >
          ...
          {showRight && (
            <button
              ...
              className="hidden md:flex absolute top-1/2 right-2 -translate-y-1/2 bg-white/40 shadow-md rounded-full p-2 hover:bg-gray-100"
            >
