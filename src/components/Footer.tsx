...
const Footer = () => {
  ...
  const socialIcons = [
    ...
    { icon: Instagram, label: "Instagram", color: "from-pink-600 via-purple-600 to-indigo-600" },
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              ...
              <div className="lg:col-span-1">
                ...
                <p className="text-gray-300 leading-relaxed mb-6">
                  Your ultimate shopping destination for the best deals and latest trends. 
                  Experience premium quality with unbeatable prices.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {["About Us", "Contact", "Blog", "Careers"].map((item, index) => (
                    <li key={index}>
                      <a
                        href="#"
                        className="text-gray-300 hover:text-white relative group transition-all duration-300 block py-1"
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {["Help Center", "Returns & Refunds", "Shipping Info", "Size Guide"].map((item, index) => (
                    <li key={index}>
                      <a
                        href="#"
                        className="text-gray-300 hover:text-white relative group transition-all duration-300 block py-1"
